...
public class DynaCode {
	...
	public static String getPackageName(String code) {
		String packageName = StringUtils.substringBefore(StringUtils.substringAfter(code, "package "), ";").trim();
		return packageName;
	}
	...
	public static Class<?> compileAndLoadClass(final String className, final String javaSource) throws Exception {
