...
public class FAQUrl {
	...
	public static String suggestTodo(final String url) {
		...
		builder.append(TipStringBegin);
		builder.append(url);
		builder.append(TipStringEnd);
	...
	public static String attachDefaultURL(final String errorMessage) {
		if (errorMessage != null) {
			...
			if (-1 == index) {
				...
				builder.append("\n");
				builder.append("For more information, please visit the url, ");
				builder.append(UNEXPECTED_EXCEPTION_URL);
				return builder.toString();
			}
		}
